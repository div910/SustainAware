"""
Django settings for sustainaware_backend project.
...
SECRET_KEY = 'django-insecure-s=4hzh(mkmo=k(%s@@)(+qq4t%d7@^t#%_)mn=%1a5ke7pqnqx'
...
INSTALLED_APPS = [
    ...
    'sustainaware_backend.apps.profile',
...
WSGI_APPLICATION = 'sustainaware_backend.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'sustainaware',
        'USER': 'wakeup',
        'PASSWORD': 'WakeUp#5679',
        'HOST': 'wake-up-backend.crw08cqtbmny.ap-south-1.rds.amazonaws.com',
        'POST': 3306
    }
}
